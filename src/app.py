...
activities = {
    ...
    "Basketball Club": {
        "description": "Develop basketball skills and play in friendly games",
    ...
    "Drama Club": {
        "description": "Perform plays, practice improvisation, and build stage confidence",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["amelia@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Club": {
        "description": "Solve puzzles, participate in math competitions, and sharpen problem-solving skills",
